    ...
    def get(self, request, book_id):
        ...
        try:
            ...
            if not book_obj:
                ...
                descripiton = res.json()["volumeInfo"]["description"] if ("description" in res.json()["volumeInfo"]) else None,
...
class BookReviews(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            review_obj = BookReview.objects.create(book = book_obj, user = user, comment = data.get("comment"), rating  = data.get("rating"))
